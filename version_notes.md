...
- **Mise en place de la Suite de Tests (86 tests xUnit)** :
  ...
  - Écriture de tests d'intégration (un test offline/online mocké et un test de bout en bout réel avec les serveurs Render et Neon).
